    ...
    return(
        ...
        <div className="main">
            <div className="articleContainer">
                ...
                <div className="article 3"><div className="main-image" style={{ backgroundImage: `url(${noteImg})`, backgroundSize: 'cover' }}><div className="main-desc"><h2>Note Finder</h2><p>노트 피라미드에 각 노트별로 원하는 향을 골라보세요<br/>노트별로 고르신 향으로 이루어진 향수를 보여드립니다.</p></div><button className="main-btn" onClick={()=>nav("/NoteFinderMain")}>자세히 보기</button></div></div>
